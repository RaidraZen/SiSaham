📈 SiSaham
Intelligent Research Assistant for IHSG Retail Investors

SiSaham adalah Chrome Extension yang mendigitalisasi riset investasi dengan menyederhanakan akses data fundamental emiten dan berita pasar modal Indonesia secara real-time.
...
1. Konfigurasi Azure
Unggah dokumen laporan keuangan ke Azure Blob Storage.

Hubungkan Blob Storage sebagai data source di Azure AI Search dan buat index.
...
Pilih folder dist hasil proses build.

Ikon SiSaham siap digunakan pada toolbar browser.